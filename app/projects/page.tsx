...
const Projects = () => {
    return (
        <main className="grid grid-rows-[1fr] items-center justify-items-center min-h-screen pb-[350px] relative top-20 md:pb-20 font-[family-name:var(--font-gopher-sans)]">
            <Hero>
                <section className="md:border-r-4 border-foreground px-10 flex flex-col gap-y-8 relative">
                    <h1 className="text-3xl md:text-4xl lg:text-6xl font-[family-name:var(--font-gopher-bold-sans)] ">Projects.</h1>
                    <p className="text-wrap w-56 text-xs md:text-base md:w-72">
